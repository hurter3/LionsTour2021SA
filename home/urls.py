...
from .views import home_view, history_view, photos_view, fixtures_view, tickets_view, contact_view, competition_rules_view
...
urlpatterns = [
    ...
    url('competition/rules/', competition_rules_view, name="competition-rules"),
]
